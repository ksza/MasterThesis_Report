...
The source code is included with the thesis in the \emph{EgoSim\_SourceCode.zip} archive. You can also find the source code of this project on GitHub \cite{egosim:online}. Using the framework to set up a new simulation is described in details in Appendix \ref{ch:user_guide}.\\
