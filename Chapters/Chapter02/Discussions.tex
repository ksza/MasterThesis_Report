...
\begin{table}[H]
	\begin{center}
		\small \begin{tabular*}{1.1\columnwidth}{p{6.5cm}llll}
			...
			Agent's field of vision & no & no & yes & yes \\ \hline
...
% In the remainder of this section we will discuss each related system's pros and cons in regards to the characteristics depicted in the table.

% %************************************************
% \subsection{DiaSim}\label{subsec:discussion_diasim}
% %************************************************
% DiaSim \ref{sec:diasim} is a simulator for pervasive computing applications based on sensors and actuators. It includes a simulation renderer, enabling the researcher to visually monitor and debug the pervasive computing system. It does so by rendering the simulated environment in a 2D view.
